...
type Http struct {
	...
	Rules []*HttpRule `protobuf:"bytes,1,rep,name=rules,proto3" form:"rules" json:"rules" query:"rules"`
	...
	// segment matches.
	FullyDecodeReservedExpansion bool `protobuf:"varint,2,opt,name=fully_decode_reserved_expansion,json=fullyDecodeReservedExpansion,proto3" form:"fully_decode_reserved_expansion" json:"fullyDecodeReservedExpansion" query:"fully_decode_reserved_expansion"`
}
...
type HttpRule struct {
	...
	// details.
	Selector string `protobuf:"bytes,1,opt,name=selector,proto3" form:"selector" json:"selector" query:"selector"`
	...
	// message type.
	Body string `protobuf:"bytes,7,opt,name=body,proto3" form:"body" json:"body" query:"body"`
	...
	// message type.
	ResponseBody string `protobuf:"bytes,12,opt,name=response_body,json=responseBody,proto3" form:"response_body" json:"responseBody" query:"response_body"`
	// Additional HTTP bindings for the selector. Nested bindings must
	// not contain an `additional_bindings` field themselves (that is,
	// the nesting may only be one level deep).
	AdditionalBindings []*HttpRule `protobuf:"bytes,11,rep,name=additional_bindings,json=additionalBindings,proto3" form:"additional_bindings" json:"additionalBindings" query:"additional_bindings"`
}
...
type CustomHttpPattern struct {
	...
	Kind string `protobuf:"bytes,1,opt,name=kind,proto3" form:"kind" json:"kind" query:"kind"`
	// The path matched by this custom verb.
	Path string `protobuf:"bytes,2,opt,name=path,proto3" form:"path" json:"path" query:"path"`
}
...
var file_google_api_http_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x94, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x09, 0x48, 0x74, 0x74,
	0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x6e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67,
